 ...
 * @hidden
 */
export let DataLegendDescription = /*@__PURE__*/ (() => {
    class DataLegendDescription extends Description {
        get_type() {
            return "DataLegend";
        }
        get type() {
        ...
        get calculateColumnSummaryRef() {
            return this.d3;
        }
        set calculateColumnSummaryRef(a) {
            this.d3 = a;
            this.g("CalculateColumnSummaryRef");
        }
        get styleHeaderRowRef() {
            return this.eo;
        }
        ...
        get styleGroupRowRef() {
            return this.en;
        }
        set styleGroupRowRef(a) {
            this.en = a;
            this.g("StyleGroupRowRef");
        }
        get styleSeriesRowRef() {
            return this.eq;
        }
        set styleSeriesRowRef(a) {
            this.eq = a;
            this.g("StyleSeriesRowRef");
        }
        get styleSummaryRowRef() {
            return this.es;
        }
        set styleSummaryRowRef(a) {
            this.es = a;
            this.g("StyleSummaryRowRef");
        }
        get styleSeriesColumnRef() {
            return this.ep;
        }
        set styleSeriesColumnRef(a) {
            this.ep = a;
            this.g("StyleSeriesColumnRef");
        }
        get styleSummaryColumnRef() {
            return this.er;
        }
        set styleSummaryColumnRef(a) {
            this.er = a;
    ...
    DataLegendDescription.$t = /*@__PURE__*/ markType(DataLegendDescription, 'DataLegendDescription', Description.$);
