...
export let DataSeriesAdapterImplementation = /*@__PURE__*/ (() => {
    class DataSeriesAdapterImplementation extends Base {
        constructor() {
            ...
            this.a7(this.rules);
            let a = this.rules;
            a.collectionChanged = delegateCombine(a.collectionChanged, runOn(this, this.bf));
        }
        as(a, b) {
            let c = this.ad;
            let d = this.af();
        ...
        h(a, b) {
            ...
            if (typeCast(IDataSource_$type, a) !== null) {
                ...
                h.f = a;
                this.sortDescriptions.o(h.f.sortDescriptions);
                this.groupDescriptions.o(h.f.groupDescriptions);
                this.filterExpressions.o(h.f.filterExpressions);
                this.summaryDescriptions.o(h.f.summaryDescriptions);
                c.e.add(() => {
                    this.sortDescriptions.s(h.f.sortDescriptions);
                    this.groupDescriptions.s(h.f.groupDescriptions);
                    this.filterExpressions.s(h.f.filterExpressions);
                    this.summaryDescriptions.s(h.f.summaryDescriptions);
                });
                if (f == 2) {
                    let i = this.q(c, h);
                    c.c = i;
            ...
            if (b && this.ad) {
                ...
                k.f = j;
                this.sortDescriptions.o(k.f.sortDescriptions);
                this.groupDescriptions.o(k.f.groupDescriptions);
                this.filterExpressions.o(k.f.filterExpressions);
                this.summaryDescriptions.o(k.f.summaryDescriptions);
                c.e.add(() => {
                    this.sortDescriptions.s(k.f.sortDescriptions);
                    this.groupDescriptions.s(k.f.groupDescriptions);
                    this.filterExpressions.s(k.f.filterExpressions);
                    this.summaryDescriptions.s(k.f.summaryDescriptions);
                });
        ...
        q(a, b) {
            ...
            a.e.add(() => this.postSortDescriptions.s(d.m.sortDescriptions));
            return d;
        }
        aw(a, b, c) {
            this.av(c);
