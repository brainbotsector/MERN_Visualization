...
export let LocalDataSource = /*@__PURE__*/ (() => {
    class LocalDataSource extends BaseDataSource {
        ...
        constructor() {
            ...
            this.c8 = null;
            this.c4 = null;
            this.dj = new List$1(Array_$type, 0);
            this.c9 = false;
            this.cv = null;
            this.ds = -1;
            this.dk = -1;
        ...
        unpinRow(a) {
            ...
            let b = this.c5();
            if (this.c6 != null) {
                for (let c = this.dj.count - 1; c >= 0; c--) {
                    let d = this.dj._inner[c];
                ...
                for (let e = this.dj.count - 1; e >= 0; e--) {
                    let f = this.dj._inner[e];
        ...
        clearPinnedRows() {
            for (let a = this.dj.count - 1; a >= 0; a--) {
