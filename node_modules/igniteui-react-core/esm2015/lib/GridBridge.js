...
export let GridBridge = /*@__PURE__*/ (() => {
    class GridBridge extends PanelBridge {
        ...
        getColumn(a, b) {
            let c = b.al.getStyleProperty("grid-column");
            let d = parseInt(c);
            return d - 1;
        }
        ...
        getRow(a, b) {
            let c = b.al.getStyleProperty("grid-row");
            let d = parseInt(c);
            return d - 1;
        }
        ...
        setValue(a, b, c) {
            ...
            switch (b) {
                case 38:
                    ...
                    a.setStyleProperty("place-content", (EnumUtil.getEnumValue(NativeUIBoxSizing_$type, c)) == 0 ? "center" : "unset");
                    break;
            }
        }
