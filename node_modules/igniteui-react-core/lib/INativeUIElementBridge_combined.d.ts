...
export declare class NativeUIComponent extends Base {
    ...
    protected get ak(): any;
    private static v;
    static ap(a: INativeUIElementFactory): void;
    private static a;
    static aq(a: any, b: NativeUIComponentBuiltInType, c: NativeUIElementFactoryFlavor, d: (arg1: any) => void): void;
    static ar(a: any, b: NativeUIComponentBuiltInType, c: (arg1: any) => void): void;
    static as(a: any, b: NativeUIComponentBuiltInType[], c: NativeUIElementFactoryFlavor[], d: (arg1: any[]) => void): void;
    static at(a: any, b: NativeUIComponentBuiltInType[], c: (arg1: any[]) => void): void;
    static au(a: any, b: NativeUIComponentBuiltInType, c: NativeUIElementFactoryFlavor, d: (arg1: any) => void): void;
    static av(a: any, b: NativeUIComponentBuiltInType, c: (arg1: any) => void): void;
    d: INativeUIElementBridge;
    al: any;
    protected aj(a: UIElementPropertyId): any;
    protected ag(a: UIElementPropertyId): any;
    protected a2(a: UIElementPropertyId, b: any): void;
    protected ae(a: NativeUIBuiltInProperties): any;
    protected a0(a: NativeUIBuiltInProperties, b: any): void;
    protected an(a: NativeUIBuiltInEvents, b: any): void;
    protected ao(a: any, b: NativeUIComponent, c: NativeUIBuiltInEvents, d: any): void;
    protected ay(a: NativeUIBuiltInEvents, b: any): void;
    protected az(a: any, b: NativeUIComponent, c: NativeUIBuiltInEvents, d: any): void;
    protected af(a: any, b: NativeUIBuiltInProperties): any;
    protected a1(a: any, b: NativeUIBuiltInProperties, c: any): void;
    protected ai(a: NativeUIBuiltInProperties): any;
    protected ah(a: NativeUIBuiltInEvents): any;
    get ad(): number;
    set ad(a: number);
    get x(): number;
    set x(a: number);
...
export declare class NativeUIContainer extends NativeUIComponent {
    static $t: Type;
    get bi(): number;
    get bg(): INativeUIContainerBridge;
    bh(a: number): NativeUIComponent;
    bm(a: number): void;
    bj(a: NativeUIComponent): void;
    bk(a: number, b: NativeUIComponent): void;
    bl(a: NativeUIComponent): void;
}
