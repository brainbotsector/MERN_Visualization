...
export declare class ComponentRenderer extends Base {
    ...
    private av;
    private a4;
    get a8(): Dictionary$2<any, ContainerState>;
    private a1;
    private aw;
    private au;
    private a3;
    ...
    dl(a: any, b: string, c: any, d: boolean): void;
    removeRefValueCore(a: any, b: string, c: boolean): void;
    clearUserRefValues(): void;
    t(a: DescriptionRef): boolean;
    b5(a: DescriptionRef): any;
    ...
    private d1;
    private ao;
    c6(a: any, b: any, c: ContainerState): void;
    private bf;
    private ai;
    private dp;
    private an;
