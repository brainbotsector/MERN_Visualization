...
export declare class FlatDataProvider extends Base implements IDataSourceLocalDataProvider, INotifyPropertyChanged {
    ...
    set ak(a: string);
    private h;
    get i(): FlatDataProviderJoinType;
    set i(a: FlatDataProviderJoinType);
    private e;
    get g(): FlatDataProviderJoinCollisionType;
    set g(a: FlatDataProviderJoinCollisionType);
    private ab;
    get am(): string;
    set am(a: string);
    ...
    private u;
    x(): any;
    a8(a: any, b: string, c: any): void;
    t(a: any, b: string): boolean;
    private aq;
    private at;
    private y;
