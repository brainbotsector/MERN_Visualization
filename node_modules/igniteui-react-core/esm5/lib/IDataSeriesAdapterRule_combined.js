...
var DataSeriesAdapterImplementation = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function DataSeriesAdapterImplementation() {
        ...
        _this.a7(_this.rules);
        var a = _this.rules;
        a.collectionChanged = delegateCombine(a.collectionChanged, runOn(_this, _this.bf));
        return _this;
    }
    ...
    DataSeriesAdapterImplementation.prototype.bf = function (a, b) {
        this.refresh();
    };
    ...
    Object.defineProperty(DataSeriesAdapterImplementation.prototype, "supportedSeriesTypes", {
        ...
        set: function (a) {
            ...
            this.c = a;
            if (b != this.c) {
                this.a2("SupportedSeriesTypes", b, this.c);
            }
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(DataSeriesAdapterImplementation.prototype, "includedProperties", {
        ...
        set: function (a) {
            ...
            this.b = a;
            if (b != this.b) {
                this.a2("IncludedProperties", b, this.b);
            }
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(DataSeriesAdapterImplementation.prototype, "excludedProperties", {
        ...
        set: function (a) {
            ...
            this.a = a;
            if (b != this.a) {
                this.a2("ExcludedProperties", b, this.a);
            }
        },
        enumerable: false,
        configurable: true
    ...
    DataSeriesAdapterImplementation.prototype.a2 = function (a, b, c) {
        this.a8(a, b, c);
        if (this.propertyChanged != null) {
            this.propertyChanged(this, new PropertyChangedEventArgs(a));
        }
    };
    DataSeriesAdapterImplementation.prototype.a8 = function (a, b, c) {
        switch (a) {
            case "ItemsSource":
                this.refresh();
                break;
    ...
    DataSeriesAdapterImplementation.prototype.be = function () {
        var e_2, _a;
        try {
    ...
    DataSeriesAdapterImplementation.prototype.bc = function (a) {
        var e_4, _a;
    ...
    DataSeriesAdapterImplementation.prototype.bh = function (a) {
        for (var b = 0; b < this.rules.count; b++) {
            this.bg(a, this.rules._inner[b]);
        }
    };
    ...
    DataSeriesAdapterImplementation.prototype.h = function (a, b) {
        ...
        if (typeCast(IDataSource_$type, a) !== null) {
            ...
            h_1.f = a;
            this.sortDescriptions.o(h_1.f.sortDescriptions);
            this.groupDescriptions.o(h_1.f.groupDescriptions);
            this.filterExpressions.o(h_1.f.filterExpressions);
            this.summaryDescriptions.o(h_1.f.summaryDescriptions);
            c.e.add(function () {
                _this.sortDescriptions.s(h_1.f.sortDescriptions);
                _this.groupDescriptions.s(h_1.f.groupDescriptions);
                _this.filterExpressions.s(h_1.f.filterExpressions);
                _this.summaryDescriptions.s(h_1.f.summaryDescriptions);
            });
            if (f == 2) {
                var i = this.q(c, h_1);
                c.c = i;
        ...
        if (b && this.ad) {
            ...
            k_1.f = j;
            this.sortDescriptions.o(k_1.f.sortDescriptions);
            this.groupDescriptions.o(k_1.f.groupDescriptions);
            this.filterExpressions.o(k_1.f.filterExpressions);
            this.summaryDescriptions.o(k_1.f.summaryDescriptions);
            c.e.add(function () {
                _this.sortDescriptions.s(k_1.f.sortDescriptions);
                _this.groupDescriptions.s(k_1.f.groupDescriptions);
                _this.filterExpressions.s(k_1.f.filterExpressions);
                _this.summaryDescriptions.s(k_1.f.summaryDescriptions);
            });
    ...
    DataSeriesAdapterImplementation.prototype.q = function (a, b) {
        ...
        d.m = c;
        this.postSortDescriptions.o(d.m.sortDescriptions);
        a.e.add(function () { return _this.postSortDescriptions.s(d.m.sortDescriptions); });
        return d;
    };
    ...
    DataSeriesAdapterImplementation.prototype.av = function (a) {
        ...
        d.schemaChanged = delegateRemove(d.schemaChanged, runOn(this, this.a9));
        var e = a.b;
        if (e != null) {
            e.updateNotifier = null;
            e.schemaChanged = delegateRemove(e.schemaChanged, runOn(this, this.a9));
        }
    };
    DataSeriesAdapterImplementation.prototype.ba = function (a, b, c, d) {
    ...
    DataSeriesAdapterImplementation.prototype.at = function (a, b, c, d) {
        if (a != null && !this.ah.containsKey(a)) {
            ...
            this.ah.addItem(a, b);
            var e = b.c;
            e.schemaChanged = delegateCombine(e.schemaChanged, runOn(this, this.a9));
            if (b.b != null) {
                var f = b.b;
                f.schemaChanged = delegateCombine(f.schemaChanged, runOn(this, this.a9));
            }
            if (c != null) {
    ...
    DataSeriesAdapterImplementation.prototype.a9 = function (a, b) {
        if (!this.ac) {
            this.refresh();
        }
    };
    ...
    DataSeriesAdapterImplementation.prototype.a6 = function (a, b, c, d) {
        this.refresh();
    };
