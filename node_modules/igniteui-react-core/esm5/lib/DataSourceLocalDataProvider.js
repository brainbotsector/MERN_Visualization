...
var DataSourceLocalDataProvider = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    DataSourceLocalDataProvider.prototype.at = function (a, b) {
    ...
    Object.defineProperty(DataSourceLocalDataProvider.prototype, "af", {
        ...
        set: function (a) {
            ...
            this.ac = a;
            if (b != this.ac) {
                this.an("SchemaHints", b, this.ac);
            }
        },
        enumerable: false,
        configurable: true
    });
    DataSourceLocalDataProvider.prototype.ao = function () {
        if (this.ac == null) {
            return;
        }
        this.t.clear();
    ...
    DataSourceLocalDataProvider.prototype.as = function (a) {
        this.i = a;
        if (this.schemaChanged != null) {
            this.schemaChanged(this, new DataSourceDataProviderSchemaChangedEventArgs(this.i, this.actualCount));
        }
    ...
    DataSourceLocalDataProvider.prototype.an = function (a, b, c) {
        this.ap(a, b, c);
    };
    ...
    DataSourceLocalDataProvider.prototype.ap = function (a, b, c) {
        switch (a) {
            case "ItemsSource":
                this.i = null;
                if (b != null) {
                    if (typeCast(INotifyCollectionChanged_$type, b) !== null) {
                        ...
                        d.collectionChanged = delegateRemove(d.collectionChanged, runOn(this, this.am));
                    }
                }
                if (this.dataSource != null) {
                    ...
                    if (typeCast(INotifyCollectionChanged_$type, this.dataSource) !== null) {
                        ...
                        e.collectionChanged = delegateCombine(e.collectionChanged, runOn(this, this.am));
                    }
                }
                else {
                    this.x = null;
    ...
    DataSourceLocalDataProvider.prototype.am = function (a, b) {
        switch (b.action) {
            case 0:
                if (b.newItems != null) {
    ...
    Object.defineProperty(DataSourceLocalDataProvider.prototype, "deferAutoRefresh", {
        ...
        set: function (a) {
            ...
            this.p = a;
            if (this.p != b) {
                this.an("DeferAutoRefresh", b, this.p);
            }
        },
        enumerable: false,
        configurable: true
