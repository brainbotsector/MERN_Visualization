...
var ComponentRenderer = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function ComponentRenderer() {
        ...
        _this.ay = new Dictionary$2(Base.$, Description.$, 0);
        _this.az = new Dictionary$2(Base.$, Boolean_$type, 0);
        _this.a0 = new Dictionary$2(Base.$, Boolean_$type, 0);
        _this.ax = new Dictionary$2(Base.$, Boolean_$type, 0);
        _this.av = new Dictionary$2(Base.$, DescriptionTreeNode.$, 0);
        _this.a4 = new Dictionary$2(Base.$, ContainerState.$, 0);
        _this.a1 = new Dictionary$2(Base.$, Queue$1.$.specialize(Queue$1.$.specialize(DescriptionTreeAction.$)), 0);
        _this.aw = new Dictionary$2(Base.$, List$1.$.specialize(Delegate_$type), 0);
        _this.au = new Dictionary$2(Base.$, Boolean_$type, 0);
        _this.a3 = new Dictionary$2(String_$type, DescriptionRef.$, 0);
        _this.a5 = new Dictionary$2(String_$type, Base.$, 0);
        _this.a7 = new Dictionary$2(String_$type, Base.$, 0);
        _this.a2 = new Dictionary$2(Base.$, String_$type, 0);
        _this.bb = new List$1(Delegate_$type, 0);
        _this.a6 = new Dictionary$2(String_$type, List$1.$.specialize(Delegate_$type), 0);
        _this.a9 = new List$1(Delegate_$type, 0);
        _this.ba = new List$1(Delegate_$type, 0);
    ...
    ComponentRenderer.prototype.toJson = function (a) {
        ...
        var d = true;
        try {
            for (var _c = __values(fromEnum(this.av.keys)), _d = _c.next(); !_d.done; _d = _c.next()) {
                var e = _d.value;
                if (d) {
                    d = false;
                }
        ...
        if (this.a7.count > 0) {
            ...
            b.i();
            try {
                for (var _e = __values(fromEnum(this.a7.keys)), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var i = _f.value;
    ...
    ComponentRenderer.prototype.d5 = function (a, b, c) {
        a.f("{");
        a.i();
    ...
    ComponentRenderer.prototype.ar = function () {
        return false;
    };
    ComponentRenderer.prototype.dg = function (a) {
    };
    ComponentRenderer.prototype.de = function (a, b, c, d, e, f) {
    ...
    ComponentRenderer.prototype.be = function () {
        return null;
    };
    ...
    ComponentRenderer.prototype.cq = function (a, b, c) {
        var d = a;
        if (c != null) {
            d = c.j(b);
        }
    ...
    ComponentRenderer.prototype.c8 = function (a, b, c, d) {
        var e_3, _a;
        if (!c.b(b)) {
        ...
        if (typeCast(Array_$type, b) !== null) {
            ...
            this.adapter.forPropertyValueItem(c, a, function (r) {
                ...
                if (j_1.containsKey(k_1)) {
                    var s = j_1.item(k_1);
                    if (!d.b(r) && !d.a(s.g)) {
                        d.k(e, s.g, r, s, runOn(_this, _this.dl), f);
                    }
                    try {
                        for (var _b = __values(fromEnum(s.f())), _c = _b.next(); !_c.done; _c = _b.next()) {
                            var t = _c.value;
                            _this.c9(a + "." + t.c, t.b, c, d, e, s.g);
                        }
                    }
                    catch (e_5_1) {
                        e_5 = { error: e_5_1 };
            ...
            if (l > 0 && k_1 == 0) {
                ...
                this.adapter.forPropertyValueItem(c, r_1, function (s) {
                    ...
                    if (j_1.containsKey(k_1)) {
                        var t = j_1.item(k_1);
                        if (!d.b(s) && !d.a(t.g)) {
                            d.k(e, t.g, s, t, runOn(_this, _this.dl), f);
                        }
                        try {
                            for (var _b = __values(fromEnum(t.f())), _c = _b.next(); !_c.done; _c = _b.next()) {
                                var u = _c.value;
                                _this.c9(r_1 + "." + u.c, u.b, c, d, e, t.g);
                            }
                        }
                        catch (e_6_1) {
                            e_6 = { error: e_6_1 };
    ...
    Object.defineProperty(ComponentRenderer.prototype, "a8", {
        get: function () {
            return this.a4;
        },
        enumerable: false,
    ...
    ComponentRenderer.prototype.d0 = function (a, b, c, d, e) {
        var _this = this;
        ...
        this.a0.item(b, d);
        this.ax.item(b, e);
        this.dh(b, function () { return _this.dy(b); });
    };
    ComponentRenderer.prototype.dh = function (a, b) {
        this.adapter.onUIThread(a, b);
    };
    ComponentRenderer.prototype.dy = function (a) {
        var e_7, _a, e_8, _b, e_9, _c, e_10, _d;
        var _this = this;
        if (this.ay.containsKey(a)) {
            var b = this.az.containsKey(a) ? this.az.item(a) : false;
            var c = this.a0.containsKey(a) ? this.a0.item(a) : false;
            var d = this.ay.item(a);
            this.ay.removeItem(a);
            var e = DescriptionTreeBuilder.createTreeWithOptions(this.context, d, this.preserveKeyOrder);
            var f = null;
            ...
            if (c) {
                ...
                if (!this.a4.containsKey(a)) {
                    this.a4.addItem(a, ((function () {
                        var $ret = new ContainerState();
                        $ret.i = a;
                        return $ret;
                    })()));
                }
                var j_2 = this.a4.item(a);
                if (i.a.count > 0) {
                    try {
                            ...
                            if (o != null) {
                                if (!j_2.b(o)) {
                                    ...
                                    if (typeCast(DescriptionTreeNode.$, p) !== null) {
                                        var q = p.g;
                                        j_2.k(a, q, o, p, runOn(this, this.dl), m.c.g);
                                    }
                                }
                            }
                        }
                                ...
                                if (x.containsKey(_this.adapter.getPropertyValue(ae, "Name").toString())) {
                                    if (!j_2.b(ae)) {
                                        ...
                                        if (typeCast(DescriptionTreeNode.$, af) !== null) {
                                            var ag = af.g;
                                            j_2.k(a, ag, ae, af, runOn(_this, _this.dl), v.c.g);
                                        }
                                    }
                                }
                                ad_1++;
    ...
    ComponentRenderer.prototype.getTargetValue = function (a, b, c) {
        var d = this.context.getMetadata(a, this.cs(b));
        var e = d.j(ComponentRenderer.platform);
        return this.adapter.getPropertyValue(c, e);
    };
    ComponentRenderer.prototype.setTargetValue = function (a, b, c, d, e) {
        var f = this.context.getMetadata(a, this.cs(b));
        var g = f.j(ComponentRenderer.platform);
    ...
    ComponentRenderer.prototype.b8 = function (a, b) {
        if (b.i == "EmbeddedRef") {
            ...
            if (d != null) {
                for (var f = 0; f < this.a9.count; f++) {
                    var g = this.a9._inner[f](a, c, d);
                    if (g != null) {
                        return g;
                    }
                }
    ...
    ComponentRenderer.bd = function (a) {
        if (typeCast(Date_$type, a) !== null) {
            return a.getTime();
        }
        if (a == null) {
    ...
    ComponentRenderer.prototype.by = function (a, b, c, d, e, f) {
        if (typeCast(JsonDictionaryObject.$, e) !== null) {
            var g = e;
    ...
    ComponentRenderer.prototype.db = function (a, b, c, d, e, f, g, h) {
        if (a) {
            e = 8;
            f = b;
            g = null;
    ...
    ComponentRenderer.prototype.resolveRefValue = function (a, b, c) {
        var _this = this;
        this.dh(a, function () {
            if (!_this.a4.containsKey(a)) {
                _this.a4.addItem(a, ((function () {
                    var $ret = new ContainerState();
                    $ret.i = a;
                    return $ret;
                })()));
            }
            var d = _this.a4.item(a);
            if (!_this.hasRef(b)) {
                c(null);
                return;
            }
    ...
    ComponentRenderer.prototype.resolveRefName = function (a, b, c) {
        ...
        this.dh(a, function () {
            ...
            var d = _this.a4.item(a);
            if (b != null && _this.a2.containsKey(b)) {
                c(_this.a2.item(b));
                return;
            }
            c(null);
    ...
    ComponentRenderer.prototype.removeRefValue = function (a, b) {
        ...
        this.dh(a, function () {
            ...
            var c = _this.a4.item(a);
            _this.removeRefValueCore(a, b, true);
        });
    };
    ComponentRenderer.prototype.dw = function (a) {
        var e_11, _a;
        var b = this.a4.item(a);
        var c = new List$1(String_$type, 0);
        try {
            for (var _b = __values(fromEnum(this.a3.keys)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var d = _c.value;
    ...
    ComponentRenderer.prototype.queueForIdle = function (a, b) {
        ...
        this.dh(a, function () {
            if (_this.w(a)) {
                ...
                if (!_this.aw.containsKey(a)) {
                    _this.aw.item(a, new List$1(Delegate_$type, 0));
                }
                _this.aw.item(a).add(b);
            }
        });
    };
    ComponentRenderer.prototype.tryFlushIdleActions = function (a) {
        if (this.w(a)) {
            if (this.aw.containsKey(a)) {
                var b = new List$1(Delegate_$type, 1, this.aw.item(a));
    ...
    ComponentRenderer.prototype.dj = function (a, b, c) {
    ...
    ComponentRenderer.prototype.cp = function (a, b) {
        ...
        var c = this.cw("", this.av.item(a), b);
        if (c.c) {
            return c.d;
        }
        return "";
    ...
    ComponentRenderer.prototype.aq = function (a, b, c, d, e, f) {
        var e_12, _a;
        if (this.a6.containsKey(c)) {
            try {
                for (var _b = __values(fromEnum(this.a6.item(c))), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var g = _c.value;
                    g(c, f, e);
                }
            }
    ...
    ComponentRenderer.prototype.bw = function (a, b, c) {
        var d = this.bx(a.g, a, b, c);
        return d;
    };
    ComponentRenderer.prototype.bx = function (a, b, c, d) {
        if (typeof a === 'string') {
    ...
    ComponentRenderer.prototype.ck = function (a, b) {
    ...
    ComponentRenderer.prototype.bp = function (a, b, c) {
        ...
        var f = this.b0(d, a.g, b, c, false, a.c.g, a.d);
        return f;
    };
    ComponentRenderer.prototype.cj = function (a, b) {
        return a.g == null ? null : this.e(a.g, b);
    };
    ...
    ComponentRenderer.prototype.bg = function (a, b, c) {
        if (a.g == null) {
            return null;
        }
        var d = a.g;
        ...
        for (var g = 0; g < d.length; g++) {
            ...
            var j = this.b0(h, d[g], b, c, false, a.c.g, a.d);
            e.add1(j);
        }
        return e.toArray();
    };
    ComponentRenderer.prototype.d8 = function (a, b, c, d, e, f, g) {
        var _this = this;
        if (typeCast(DescriptionRef.$, e) !== null) {
            ...
            l = function (m, n) {
                var o = m;
                if (o.e != null && o.e.length > 0 && _this.a5.containsKey(o.e)) {
                    o.a = true;
                }
                var p = _this.b5(m);
                _this.d9(g, c, d, p, f, o);
            };
            if (!i) {
                h.g(a, g, c, l);
            }
    ...
    ComponentRenderer.prototype.dl = function (a, b, c, d) {
        var e = null;
        if (d) {
    ...
    ComponentRenderer.prototype.clearUserRefValues = function () {
        ...
        try {
            for (var _c = __values(fromEnum(this.a7.keys)), _d = _c.next(); !_d.done; _d = _c.next()) {
                var b = _d.value;
                a.add(b);
            }
        }
    ...
    ComponentRenderer.prototype.getRefChangeInfos = function (a) {
        ...
        if (this.a3.containsKey(a)) {
            ...
            try {
                for (var _b = __values(fromEnum(this.a3.item(a).b)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var c = _c.value;
                    _loop_2(c);
                }
            }
    ...
    ComponentRenderer.prototype.ap = function (a, b, c, d) {
    ...
    ComponentRenderer.prototype.d1 = function (a, b, c, d) {
        ...
        var g = this.b0(f, c.g, a, b, false, c.c.g, c.d);
    ...
    ComponentRenderer.prototype.ao = function (a, b, c) {
        ...
        this.adapter.replaceRootItem(a, e.i, this.context, function (g) {
            ...
            b.k(a, e.g, h, e, runOn(_this, _this.dl), -1);
            var i = _this.bc(e);
            _this.dj(a, b, i);
            f = true;
            if (g) {
    ...
    ComponentRenderer.prototype.c6 = function (a, b, c) {
        ...
        var d = this.bf(a, b, c);
        try {
            for (var _b = __values(fromEnum(this.a3.values)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var e = _c.value;
                e.i(b);
            }
        }
    ...
    ComponentRenderer.prototype.dp = function (a, b, c, d) {
        var e = c.i(ComponentRenderer.platform);
    ...
    ComponentRenderer.prototype.n = function (a, b, c) {
        ...
        this.adapter.replaceRootItem(a, d.i, this.context, function (f) {
            ...
            b.k(a, d.g, g, d, runOn(_this, _this.dl), -1);
            var h = _this.bc(d);
            _this.dj(a, b, h);
            e = true;
            if (f) {
    ...
    ComponentRenderer.prototype.cx = function (a, b, c, d) {
        ...
        var h = this.b0(f, c.g, a, b, false, c.c.g, c.d);
        this.adapter.addItemToCollection(e, c.d, d, c.e, h);
    };
    ComponentRenderer.prototype.b0 = function (a, b, c, d, e, f, g) {
        if (this.x(a)) {
            return b;
        }
        var h = null;
        ...
        if (typeCast(DescriptionTreeNode.$, b) !== null) {
            ...
            if (n.i == "EmbeddedRef") {
                ...
                if (p != null) {
                    for (var r = 0; r < this.a9.count; r++) {
                        var s = this.a9._inner[r](c, o, p);
                        if (s != null) {
                            return s;
                        }
                    }
    ...
    ComponentRenderer.prototype.d9 = function (a, b, c, d, e, f) {
        var e_18, _a;
        if (this.a6.containsKey(b)) {
            try {
                for (var _b = __values(fromEnum(this.a6.item(b))), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var g = _c.value;
                    g(b, a, d);
                }
            }
    ...
    ComponentRenderer.prototype.b4 = function (a, b) {
