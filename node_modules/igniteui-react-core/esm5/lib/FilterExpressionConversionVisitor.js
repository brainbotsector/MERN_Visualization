...
var FilterExpressionConversionVisitor = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    FilterExpressionConversionVisitor.prototype.m = function (a) {
        ...
        this.t("unexpected operator: " + EnumUtil.getName(FilterSyntaxTokenType_$type, a));
        return 0;
    };
    ...
    FilterExpressionConversionVisitor.prototype.f = function (a) {
        var b = this.l(a.c);
        var c = new (FunctionFilterExpression.bind.apply(FunctionFilterExpression, __spreadArray([void 0, b], __read([]), false)))();
        c.functionType = b;
        if (a.b != null) {
            var d = true;
            var g = a.b;
