...
var GeometryUtil = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GeometryUtil.q = function (a, b, c, d, e) {
        var f = Math.cos(a);
        var g = Math.sin(a);
    ...
    GeometryUtil.m = function (a, b, c, d, e) {
        var f;
        if (c) {
            f = GeometryUtil.n({ $type: Point_$type, x: a / 2, y: b / 2 }, d, e);
        }
        else {
    ...
    GeometryUtil.o = function (a, b, c, d, e) {
    ...
    GeometryUtil.h = function (a, b, c, d) {
