...
var PopupView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    PopupView.prototype.bn = function () {
        var a = this.g;
        var b = ElevationHelper.e(a.a6, a.cx, a.cw, a.cv);
        if (this.l()) {
...
var Popup = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Popup.prototype.cm = function (a, b, c) {
        if (this.av) {
            this.av = false;
    ...
    Popup.prototype.cl = function (a, b, c) {
        if (this.av) {
            this.av = false;
            this.cf("IsShown", true, this.av);
        }
    ...
    Popup.prototype.cn = function (a) {
        ...
        this.k.h(function (f) {
            ...
            _this.au = false;
            _this.ap = false;
            var g = _this.h(_this.av);
            var h = _this.g(_this.av);
            var i = _this.w.au(g, h);
            g = i.p0;
            h = i.p1;
        });
    };
    ...
    Popup.prototype.cp = function (a, b, c) {
        this.cl(a, b, c);
    };
    Popup.prototype.b9 = function (a) {
        this.c3 = a;
