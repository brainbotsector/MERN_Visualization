...
var LocalDataSource = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function LocalDataSource() {
        ...
        _this.c8 = null;
        _this.c4 = null;
        _this.dj = new List$1(Array_$type, 0);
        _this.c9 = false;
        _this.cv = null;
        _this.ds = -1;
        _this.dk = -1;
    ...
    Object.defineProperty(LocalDataSource.prototype, "dataSource", {
        ...
        set: function (a) {
            ...
            this.dy = a;
            if (b != this.dy) {
                this.onPropertyUpdated("ItemsSource", b, this.dy);
            }
        },
        enumerable: false,
        configurable: true
    ...
    LocalDataSource.prototype.db = function (a, b) {
        if (a == null && b == null) {
            return true;
        }
        if (a == null || b == null) {
    ...
    LocalDataSource.prototype.d3 = function () {
        this.actualCount = this.c6.a7.count;
        this.onBroadcastClearItems();
    };
    LocalDataSource.prototype.d6 = function (a, b, c) {
        this.actualCount = this.c6.a7.count;
    ...
    LocalDataSource.prototype.d5 = function (a, b) {
        this.actualCount = this.c6.a7.count;
    ...
    LocalDataSource.prototype.unpinRow = function (a) {
        ...
        var b = this.c5();
        if (this.c6 != null) {
            for (var c = this.dj.count - 1; c >= 0; c--) {
                var d = this.dj._inner[c];
            ...
            for (var e = this.dj.count - 1; e >= 0; e--) {
                var f = this.dj._inner[e];
    ...
    LocalDataSource.prototype.clearPinnedRows = function () {
        for (var a = this.dj.count - 1; a >= 0; a--) {
            this.unpinRow(this.dj._inner[a]);
        }
    };
    LocalDataSource.prototype.isRowPinned = function (a) {
        ...
        for (var h = 0; h < this.dj.count; h++) {
            if (c.h(this.dj._inner[h], d) == 0) {
                return true;
            }
        }
        return false;
    ...
    LocalDataSource.prototype.getStickyRowsInRange = function (a, b) {
        if (this.c6 == null || ((this.groupDescriptions == null || this.groupDescriptions.k.count == 0) && (this.summaryDescriptions == null || this.summaryDescriptions.k.count == 0) && !this.dc())) {
            return null;
        }
        var c = null;
        var d = null;
        ...
        if (c.ae == this.ds && c.aa == this.du && c.af == this.dv && c.ad == this.dt && c.ah == this.dx && c.ag == this.dw && d.ae == this.dk && d.aa == this.dm && d.af == this.dn && d.ad == this.dl && d.ah == this.dq && d.ag == this.dp && this.c6.bl == this.dr) {
            return this.cv;
        }
        this.ds = c.ae;
        this.dk = d.ae;
    ...
    LocalDataSource.prototype.clone = function () {
        ...
        if (this.da && this.dataProvider != null && typeCast(IDataSourceClonableDataProvider_$type, this.dataProvider) !== null) {
            ...
            for (var g = 0; g < f.length; g++) {
                if (f[g].transactionType == 1) {
                    ...
                    if (i != null) {
                        ...
                        if (this.dj.count > 0) {
                            var r = this.c5();
                            for (var s = 0; s < this.dj.count; s++) {
                                if (r.h(this.dj._inner[s], h) == 0) {
