...
var PieLabel = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    PieLabel.prototype.ak = function (a) {
        if (a.a.az == 3) {
            ...
            var e = GeometryUtil.n(d, this.ai, this.ah.a2 + a.a.db);
            var f = a.b4.width;
    ...
    PieLabel.prototype.am = function () {
        ...
        var a;
        var b = this.ah.ai.dc;
        var c = GeometryUtil.n(this.ah.b6(), this.ai, this.ah.a2);
        this.ap.an = c.x;
        this.ap.ap = c.y;
    ...
    PieLabel.prototype.an = function () {
        ...
        var f = GeometryUtil.n(a, this.ai, this.ah.a2);
        var g = GeometryUtil.n(a, this.ai, this.ah.a2 + this.ah.ai.db / 2);
        var h;
        var i;
        var j;
        var k = e;
...
var PieChartBase = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    PieChartBase.prototype.ca = function (a, b) {
        ...
        var g = false;
        var h = false;
        var i = GeometryUtil.n(d, e, c.a2);
        var j = GeometryUtil.n(d, f, c.a2);
    ...
    PieChartBase.g8 = function (a) {
        ...
        for (var c = 0; c < a.count; c++) {
            var d = a._inner[c];
            var e = d.ah;
            var f = GeometryUtil.n(e.b7, d.ai, e.a2);
            b[c] = f.y;
        }
    ...
    PieChartBase.prototype.gz = function () {
        ...
        try {
            for (var _b = __values(fromEnum(this.bx.a)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var i = _c.value;
                var j = GeometryUtil.m(a.width, a.height, true, (i.a3 + i.ax) / 2, f * this.c0);
                i.aw = true;
                i.a1 = this.c1;
                i.a0 = this.c1;
                i.a2 = f;
        ...
        try {
            for (var _f = __values(fromEnum(this.bw.a)), _g = _f.next(); !_g.done; _g = _f.next()) {
                ...
                if (this.az == 1 || this.az == 4) {
                    var l = h.a2 * h.a1 / 100;
                    var m = GeometryUtil.n(i, g.ai, h.a2 - (h.a2 - l) / 2);
                ...
                h.au = false;
                var r = GeometryUtil.n(i, g.ai, h.a2 + this.db);
                g.ag = 3;
                g._visibility = 0;
                g.al();
                if (g.ai < 90 && g.ai >= 0) {
    ...
    PieChartBase.c7 = function (a, b, c) {
        ...
        var e = 1;
        var f = GeometryUtil.n({ $type: Point_$type, x: 0, y: 0 }, c.ai, e);
        ...
        var p = GeometryUtil.n(a, (d + m) * 180 / Math.PI, b);
...
var Slice = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Slice.prototype.bk = function () {
        ...
        if (ar && this.b8.height > 0 && this.b8.width > 0 && !b.containsRect(aq)) {
            ...
            at.intersect(as);
            var au = GeometryUtil.j((this.a3 + this.ax) / 2);
            ...
            var az = GeometryUtil.m(this.ai.i9.width, this.ai.i9.height, true, au, this.a2 * this.ai.c0 - ay);
