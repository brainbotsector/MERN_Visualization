...
var TimeXAxis = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function TimeXAxis() {
        ...
        _this.ok = null;
        _this.ox = 0;
        _this.n8 = dateMaxValue();
        _this.n6 = dateMaxValue();
        _this.n5 = dateMaxValue();
        _this.n7 = dateMinValue();
        _this.ns = null;
        _this.ov = 0;
        ...
        _this.omission = (0);
        _this.og = -2147483648;
        _this.nq = new TimeAxisBreakCollection();
        var a = _this.breaks;
        a.collectionChanged = delegateCombine(a.collectionChanged, runOn(_this, _this.o0));
        _this.nv = new TimeAxisIntervalCollection();
        var b = _this.intervals;
        b.collectionChanged = delegateCombine(b.collectionChanged, runOn(_this, _this.o1));
        _this.nx = new TimeAxisLabelFormatCollection();
        var c = _this.labelFormats;
        c.collectionChanged = delegateCombine(c.collectionChanged, runOn(_this, _this.o2));
        _this.ox = (0);
        return _this;
    }
    TimeXAxis.prototype.get_cl = function () {
        return this.breaks != null && this.breaks.count > 0;
    };
    TimeXAxis.prototype.ej = function (a, b) {
        if (!b.c.isEmpty) {
            var c = this.oe(a, NumericScaler.ac, b.c, Rect.empty);
    ...
    TimeXAxis.prototype.oe = function (a, b, c, d) {
        ...
        var f = this.og != -2147483648 ? this.og : 0;
        var g = this.no != null ? this.no.count : 0;
        while (f < g) {
            var h = this.no.item1(f);
    ...
    TimeXAxis.prototype.hn = function (a, b, c, d) {
        this.og = 0;
        for (var e = b; e < c; e++) {
    ...
    TimeXAxis.prototype.em = function (a, b) {
        if (!b.c.isEmpty) {
    ...
    TimeXAxis.prototype.of = function (a, b, c, d) {
        var e_1, _a;
        var e = c.left;
        var f = c.width;
        if (this.categoryMode != 0) {
        ...
        if (this.no != null) {
            try {
                for (var _b = __values(fromEnum(this.no)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var j = _c.value;
    ...
    Object.defineProperty(TimeXAxis.prototype, "n0", {
        get: function () {
            return this.nz;
        },
        set: function (a) {
    ...
    TimeXAxis.prototype.hw = function (a, b, c, d) {
    ...
    TimeXAxis.prototype.iq = function (a, b) {
    ...
    TimeXAxis.prototype.c3 = function () {
        var a = _super.prototype.c3.call(this);
        this.oy();
        return a;
    };
    ...
    TimeXAxis.prototype.oz = function () {
        var e_2, _a;
        var a = this.n3(this.breaks);
        var b = (0);
        try {
    ...
    TimeXAxis.prototype.n3 = function (a) {
        ...
        var _loop_1 = function (c) {
            ...
            if (c.i != (0)) {
                var d = +(c.c) - +(c.d);
                var e_4 = this_1.n9(c.d, c.i);
                var _loop_2 = function () {
                    var f = this_1.n9(e_4, d);
                    var g = ((function () {
    ...
    TimeXAxis.prototype.n9 = function (a, b) {
        var c = dateFromTicks(a.getTime());
        c.setMilliseconds(c.getMilliseconds() + b);
        return c;
    };
    TimeXAxis.prototype.oy = function () {
        var e_5, _a;
        ...
        var a = new List$1(TimeAxisBreak.$, 1, this.n3(this.breaks));
        a.aa(function (b, c) { return b.d < c.d ? -1 : b.d > c.d ? 1 : 0; });
        var b = this.bi.vh;
        var c = new ScalerParams(0, this.bi.vh, this.bi.vw, this.ch, this.bi.vl);
    ...
    TimeXAxis.prototype.gd = function (a) {
        if (isNaN_(a)) {
            return null;
        }
    ...
    TimeXAxis.prototype.fz = function (a) {
        ...
        var c = false;
        if (this.ok != null) {
            if (typeCast(Date_$type, this.ok) !== null) {
                b = this.ok;
                c = true;
            }
        }
        var d = TimeXAxis.oj(a, c, b, this.n0, this.ox, this.labelFormats, this.fk);
        return d == null ? _super.prototype.fz.call(this, a) : d;
    };
    TimeXAxis.oj = function (a, b, c, d, e, f, g) {
        var h = TimeXAxis.oo(a, b, c, d, e, f, g);
        return dateToStringFormat(a, h, g);
    };
    TimeXAxis.oo = function (a, b, c, d, e, f, g) {
        var e_6, _a;
        var h = 0;
        if (b) {
            h = TimeXAxis.n1(a, c);
    ...
    TimeXAxis.prototype.get_ml = function () {
        return _super.prototype.get_ml.call(this) || (this.intervals != null && this.intervals.count > 0);
    };
    TimeXAxis.prototype.set_ml = function (a) {
        _super.prototype.set_ml.call(this, a);
    };
    ...
    TimeXAxis.prototype.om = function (a, b) {
        return TimeXAxis.on(this.ox, a, b);
    };
    TimeXAxis.on = function (a, b, c) {
        if (c != 2) {
            b = 0;
        }
        a = Math.abs(a);
    ...
    TimeXAxis.np = function () {
        if (TimeXAxis.nn == null) {
            TimeXAxis.nn = ((function () {
    ...
    TimeXAxis.prototype.nt = function () {
        ...
        if (this.c4 && (this.az == null || this.az.angle == 0)) {
            ...
            var e = c == 0 ? d : timeSpanFromTicks((intDivide(timeSpanTicks(this.ox), c)));
            var f = null;
            try {
                for (var _b = __values(fromEnum(TimeXAxis.np())), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var g = _c.value;
                    f = g.value;
                    if (g.key > e) {
                        break;
    ...
    TimeXAxis.prototype.nu = function () {
        var e_8, _a;
    ...
    TimeXAxis.prototype.h9 = function (a) {
        _super.prototype.h9.call(this, a);
        var b = this.bi != null ? this.bi.vh : Rect.empty;
        ...
        if (!b.isEmpty && !c.isEmpty) {
            ...
            var o = this.a5.a5();
            this.ni();
            var p = new List$1(Date_$type, 1, this.n2());
    ...
    TimeXAxis.prototype.n4 = function (a) {
        var e_9, _a;
        if (this.no == null) {
    ...
    Object.defineProperty(TimeXAxis.prototype, "ob", {
        get: function () {
            return this.n6;
        },
        set: function (a) {
    ...
    TimeXAxis.prototype.ni = function () {
        _super.prototype.ni.call(this);
        if (this.bi == null || !Extensions.b(this.bi.vw)) {
            return;
        }
        var a = new ScalerParams(0, this.bi.vh, this.bi.vw, this.ch, this.bi.vl);
        var b = this.j7();
        var c = b.left;
        var d = b.right;
        var e = b.left;
        ...
        var h = truncate(this.em(c, a));
        var i = truncate(this.em(d, a));
        var j = truncate(this.em(e, a));
        var k = truncate(this.em(f, a));
        if (j < 0 || k < 0) {
            this.ox = (0);
            return;
        }
        ...
        this.ox = +(this.visibleMaximum) - +(this.visibleMinimum);
    };
    TimeXAxis.prototype.k6 = function (a, b, c, d, e) {
        return 0;
    };
    TimeXAxis.prototype.i$f = function (a) {
        ...
        var i = c.item(g);
        var j = c.item(h);
        var k = new ScalerParams(0, this.bi.vx, this.kd, this.ch, this.bi.vl);
        this.startCursor();
        var l = this.ej(i.getTime(), k);
        var m = this.ej(a, k);
        var n = this.ej(j.getTime(), k);
        this.resetCursor();
    ...
    TimeXAxis.prototype.oh = function (a, b) {
        if (a < 0 || a >= b.count - 1) {
            return a;
        }
        var c = b.item(a);
        var d = 0;
        while (d < this.no.count) {
            var e = this.no.item1(d);
            if (c >= e.d && c <= e.c) {
                break;
            }
            d++;
        ...
        while (f < b.count) {
            ...
            c = b.item(f);
            var g = this.no.item1(d);
            if (c >= g.d && c <= g.c) {
                f++;
                continue;
            }
            d++;
            if (d > this.no.count - 1) {
                break;
            }
            g = this.no.item1(d);
            if (c >= g.d && c <= g.c) {
    ...
    TimeXAxis.prototype.oi = function (a, b) {
        if (a < 0 || a >= b.count - 1) {
            return a;
        }
        var c = b.item(a);
    ...
    TimeXAxis.prototype.o0 = function (a, b) {
        var e_10, _a;
        this.oz();
        this.oy();
        if (this.aw != null) {
    ...
    TimeXAxis.prototype.o2 = function (a, b) {
        this.h8(false);
    };
    TimeXAxis.prototype.o1 = function (a, b) {
        this.h8(false);
    };
    TimeXAxis.prototype.get_cc = function () {
        return false;
    };
    ...
    TimeXAxis.prototype.getCategorySize = function (a, b, c) {
        if (this.ox != (0)) {
            var d = timeSpanFromTicks(truncate((timeSpanTicks(this.ox) * (a.width / (this.bi != null ? this.bi.vh.width : 1)))));
            var e = timeSpanTicks(d) / timeSpanTicks(this.ov);
            var f = b.width / 4;
            return Math.min(f, b.width / (e + 1));
        }
        return _super.prototype.getCategorySize.call(this, a, b, c);
    };
    TimeXAxis.ou = function (a, b) {
        var c = Math.min(5, b);
        var d = a(0);
    ...
    TimeXAxis.prototype.ot = function () {
        var _this = this;
        if (this.mh == null || this.mh.count < 2 || this.mq == null) {
            return (0);
        }
        return TimeXAxis.ou(function (a) { return _this.mh.item(_this.mq._inner[a]); }, this.mh.count);
    };
    TimeXAxis.prototype.ne = function () {
        _super.prototype.ne.call(this);
        this.ov = this.ot();
    };
    TimeXAxis.oq = function (a) {
    ...
    TimeXAxis.prototype.itemLabelFormat = function () {
        return TimeXAxis.oq(this.ov);
    };
    TimeXAxis.prototype.m0 = function (a, b, c, d) {
        return this.mz(this.visibleMinimum);
    };
    TimeXAxis.prototype.m3 = function (a, b, c, d) {
