...
var AnchoredCategorySeriesInteractionManager = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AnchoredCategorySeriesInteractionManager.prototype.c$b = function (a, b, c, d, e, f, g, h) {
        ...
        var i = truncate(Math.round(a.h6(b)));
        if (i < 0 || i >= a.dd.count) {
            return h(b);
        }
        var j = intDivide(i, c);
        ...
        var m = a.u1(a.cl);
        var n = new ScalerParams(0, a.c1.vx, a.c1.vw, f.ch, a.c1.vl);
        var o = m.top;
        var p = m.bottom;
        var q = o + (p - o) * b.y;
        var r = f.em(q, n);
    ...
    AnchoredCategorySeriesInteractionManager.prototype.c$a = function (a, b, c, d, e, f) {
        ...
        var j = !g.isEmpty && !h.isEmpty && a.dd != null ? a.dd.indexOf(f) : -1;
        var k = a.u3(a.cl);
        var l = new ScalerParams(0, i, i, c.ch, k);
        var m = new ScalerParams(0, i, i, d.ch, k);
        m.b = a.id();
        var n = c != null ? c.ej(j, l) : NaN;
        n += e;
        var o = d != null && b != null && j < b.count ? d.ej(b.item(j), m) : NaN;
        if (!isNaN_(n)) {
    ...
    AnchoredCategorySeriesInteractionManager.prototype.c$c = function (a, b) {
        ...
        else if (d != null && d.f0 != null) {
            c += "<span>${item." + d.f0.toString() + "}</span><br/>";
        }
        c += "<span";
        var f = a.a2.a$t(a);
    ...
    AnchoredCategorySeriesInteractionManager.prototype.c$d = function (a, b, c, d, e, f, g, h) {
        ...
        var j = a.cl.by;
        var k = a.cl.bx;
        var l = a.getEffectiveViewport1(a.cl);
