...
var CategoryYAxis = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CategoryYAxis.prototype.m6 = function () {
        ...
        var a = !isNaN_(this.bi.ii) && !isNaN_(this.bi.ik);
        if (a) {
            return;
        }
