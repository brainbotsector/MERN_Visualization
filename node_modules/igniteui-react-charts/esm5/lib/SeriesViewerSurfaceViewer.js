...
var SeriesViewerSurfaceViewer = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Object.defineProperty(SeriesViewerSurfaceViewer.prototype, "maximumZoomLevel", {
        get: function () {
            if (this.l.hd == 0.0001 && this.l.hc == 0.0001) {
                return 0.9;
            }
            else {
                return 1 - Math.max(this.l.hd, this.l.hc);
            }
        },
        enumerable: false,
        configurable: true
        ...
        switch (a) {
            case SeriesViewerSurfaceViewer.$$p[0]:
                ...
                if (!this.o && !d) {
                    ...
                    var f = RectUtil.l(this.l.vh);
                    var g = new Rect(0, f.x - e / 2, f.y - e / 2, e, e);
                    this.l.vx = SeriesViewerSurfaceViewer.z(this.l.vx, g, this.l.ff(), this.l.fg(), this.worldRect);
                }
                this.w();
                if (this.l.c1 != null) {
