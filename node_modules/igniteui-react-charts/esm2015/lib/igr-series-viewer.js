...
export class IgrSeriesViewer extends React.Component {
    ...
    */
    ...
    queueForAnimationIdle(action, version) {
        this.i.queueForAnimationIdle(action, version);
    }
    getAnimationIdleVersionNumber() {
        let iv = this.i.getAnimationIdleVersionNumber();
        return (iv);
    }
    isAnimationActive() {
        let iv = this.i.isAnimationActive();
        return (iv);
    }
    /**
    ...
    */
    ...
    set selectedSeriesItemsChanged(ev) {
        ...
        this._selectedSeriesItemsChanged_wrapped = (o, e) => {
            let outerArgs = new IgrSeriesViewerSelectedSeriesItemsChangedEventArgs();
            outerArgs._provideImplementation(e);
    ...
    */
    ...
    set imageCaptured(ev) {
        ...
        this._imageCaptured_wrapped = (o, e) => {
            let outerArgs = new IgrImageCapturedEventArgs();
            outerArgs._provideImplementation(e);
