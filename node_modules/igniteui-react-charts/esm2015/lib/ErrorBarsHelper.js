...
export let ErrorBarsHelper = /*@__PURE__*/ (() => {
    class ErrorBarsHelper extends Base {
        ...
        k(a, b, c, d, e) {
            ...
            d = Math.abs(Math.round(c.ej(a + l, j) - k));
            e = Math.abs(Math.round(c.ej(a - l, j) - k));
            return {
                p3: d,
                p4: e
            };
        ...
        j(a, b, c, d, e) {
            ...
            d = Math.abs(Math.round(c.ej(j + k, i) - a));
            e = Math.abs(Math.round(c.ej(j - k, i) - a));
            return {
                p3: d,
                p4: e
            };
        ...
        f(a, b, c, d, e, f) {
            ...
            e = Math.abs(Math.round(c.ej(l + m, k) - a));
            f = Math.abs(Math.round(c.ej(l - m, k) - a));
            return {
                p4: e,
                p5: f
            };
        ...
        h(a, b, c, d, e) {
            ...
            let i = new ScalerParams(1, f, g, c.ch);
            let j = c.em(a, i);
            d = Math.abs(Math.round(c.ej(j + b, i) - a));
            e = Math.abs(Math.round(c.ej(j - b, i) - a));
            return {
                p3: d,
                p4: e
            };
