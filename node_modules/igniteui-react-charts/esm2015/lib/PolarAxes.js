...
export let PolarAxes = /*@__PURE__*/ (() => {
    class PolarAxes extends Base {
        ...
        e(a, b, c, d, e, f, g, h) {
            ...
            let n;
            let o;
            let p = Math.min(this.a.lx, this.a.lw);
            let q = Math.max(this.a.lx, this.a.lw);
            let r = Math.min(this.b.lw, this.b.lx);
            let s = Math.max(this.b.lw, this.b.lx);
            let t = this.a.lj;
            let u = this.a.ch;
            let v = this.b.lj;
            let w = this.b.ch;
