...
*/
    ...
    */
    ...
    set legendItemBadgeMode(v) {
        this.i.a5 = ensureEnum(LegendItemBadgeMode_$type, v);
    }
    /**
    ...
    */
    ...
    set lineJoin(v) {
        this.i.un = ensureEnum(PenLineJoin_$type, v);
    }
    /**
    ...
    */
    ...
    set highlightedValuesDisplayMode(v) {
        this.i.bm = ensureEnum(SeriesHighlightedValuesDisplayMode_$type, v);
    }
    /**
     * Gets or sets whether and how to display highlighted values for the series. Note, this is distinct from the highlighting feature that indicates what is closest or under the mouse.
    */
    ...
    */
    get dashArray() {
        return fromDoubleCollection(this.i.uk);
    }
    set dashArray(v) {
        this.i.uk = toDoubleCollection(v);
    }
    /**
    ...
    */
    ...
    set actualHighlightingMode(v) {
        this.i.bo = ensureEnum(SeriesHighlightingMode_$type, v);
    }
    /**
    ...
    */
    ...
    set actualSelectionMode(v) {
        this.i.cf = ensureEnum(SeriesSelectionMode_$type, v);
    }
    /**
     * Gets actual Selection mode
    */
    ...
    set actualFocusMode(v) {
        this.i.ce = ensureEnum(SeriesSelectionMode_$type, v);
    }
    /**
    ...
    */
    get shadowColor() {
        return colorToString(this.i.uj);
    }
    set shadowColor(v) {
        this.i.uj = stringToColor(v);
    }
    /**
    ...
    */
    ...
    set visibleRangeMode(v) {
        this.i.cp = ensureEnum(SeriesVisibleRangeMode_$type, v);
    }
    /**
    ...
    */
    ...
    set outlineMode(v) {
        this.i.b8 = ensureEnum(SeriesOutlineMode_$type, v);
    }
    /**
    ...
    */
    ...
    set transitionInSpeedType(v) {
        this.i.cv = ensureEnum(TransitionInSpeedType_$type, v);
    }
    /**
     * Gets or sets the duration of the current series' transition out morph.
    */
    ...
    set transitionOutSpeedType(v) {
        this.i.cy = ensureEnum(TransitionOutSpeedType_$type, v);
    }
    /**
    ...
    */
    ...
    set lineCap(v) {
        this.i.um = ensureEnum(PenLineCap_$type, v);
    }
    /**
    ...
    */
    ...
    set hitTestMode(v) {
        this.i.bu = ensureEnum(SeriesHitTestMode_$type, v);
    }
    /**
    ...
    */
    ...
    set actualHitTestMode(v) {
        this.i.bs = ensureEnum(SeriesHitTestMode_$type, v);
    }
    /**
    ...
    */
    get layers() {
        if (this._layers === null) {
            let coll = new IgrSeriesLayerCollection();
            let innerColl = this.i.b2;
            if (!innerColl) {
...
*/
    ...
    */
    getExactItemIndex(world) {
        let iv = this.i.h6(toPoint(world));
        return (iv);
    }
    /**
    ...
    */
    getSeriesValueTypePosition(mode) {
        let iv = this.i.ux((mode == null ? null : mode));
        return fromPoint(iv);
    }
    getSeriesValueTypePositionFromValue(values) {
        let iv = this.i.uy(values);
        return fromPoint(iv);
    }
    /**
    ...
    */
    toWorldPosition(seriesPoint) {
        let iv = this.i.uz(toPoint(seriesPoint));
        return fromPoint(iv);
    }
    /**
    ...
    */
    fromWorldPosition(world) {
        let iv = this.i.up(toPoint(world));
        return fromPoint(iv);
    }
    /**
    ...
    */
    ...
    setNegativeColors(negativeBrush, negativeOutline) {
        this.i.qw(stringToBrush(negativeBrush), stringToBrush(negativeOutline));
    }
    /**
    ...
    */
    ...
    set transitionOutCompleted(ev) {
        ...
        this._transitionOutCompleted_wrapped = (o, e) => {
            let outerArgs = new IgrTransitionOutCompletedEventArgs();
