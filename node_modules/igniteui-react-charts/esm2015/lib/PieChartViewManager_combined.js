    ...
    class PieLabel extends Control {
        ...
        ak(a) {
            if (a.a.az == 3) {
                ...
                let e = GeometryUtil.n(d, this.ai, this.ah.a2 + a.a.db);
                let f = a.b4.width;
        ...
        am() {
            ...
            let a;
            let b = this.ah.ai.dc;
            let c = GeometryUtil.n(this.ah.b6(), this.ai, this.ah.a2);
            this.ap.an = c.x;
            this.ap.ap = c.y;
        ...
        an() {
            ...
            let f = GeometryUtil.n(a, this.ai, this.ah.a2);
            let g = GeometryUtil.n(a, this.ai, this.ah.a2 + this.ah.ai.db / 2);
            let h;
            let i;
            let j;
            let k = e;
            ...
            if (d > 0) {
                ...
                if (d < l) {
                    i = GeometryUtil.p(j, f, d);
                    let m = g.x - f.x;
                    let n = g.y - f.y;
                    g = GeometryUtil.p(g, f, d);
                    let o = g.x - f.x;
                    let p = g.y - f.y;
                    if ((m > 0 && o < 0) || (m < 0 && o > 0) || (n > 0 && p < 0) || (n < 0 && p > 0)) {
                        g = f;
                    }
                    h = GeometryUtil.p(h, f, d);
...
export let PieChartBase = /*@__PURE__*/ (() => {
    class PieChartBase extends Control {
        ...
        ca(a, b) {
            ...
            let g = false;
            let h = false;
            let i = GeometryUtil.n(d, e, c.a2);
            let j = GeometryUtil.n(d, f, c.a2);
        ...
        static g8(a) {
            ...
            for (let c = 0; c < a.count; c++) {
                let d = a._inner[c];
                let e = d.ah;
                let f = GeometryUtil.n(e.b7, d.ai, e.a2);
                b[c] = f.y;
            }
        ...
        gq() {
            ...
            for (let c = 0; c < a; c++) {
                ...
                if (this.br != null && this.br.count > 0) {
                    ...
                    m.aj = l;
                    l.ai = GeometryUtil.j((m.a3 + m.ax) / 2);
                    l.ah = m;
                    l.aj = ((() => {
        ...
        gz() {
            ...
            for (let i of fromEnum(this.bx.a)) {
                let j = GeometryUtil.m(a.width, a.height, true, (i.a3 + i.ax) / 2, f * this.c0);
                i.aw = true;
                i.a1 = this.c1;
                i.a0 = this.c1;
                i.a2 = f;
        ...
        gx() {
            ...
            for (let g of fromEnum(this.bw.a)) {
                ...
                if (this.az == 1 || this.az == 4) {
                    let l = h.a2 * h.a1 / 100;
                    let m = GeometryUtil.n(i, g.ai, h.a2 - (h.a2 - l) / 2);
                ...
                h.au = false;
                let r = GeometryUtil.n(i, g.ai, h.a2 + this.db);
                g.ag = 3;
                g._visibility = 0;
                g.al();
                if (g.ai < 90 && g.ai >= 0) {
        ...
        static c7(a, b, c) {
            ...
            let e = 1;
            let f = GeometryUtil.n({ $type: Point_$type, x: 0, y: 0 }, c.ai, e);
            ...
            let p = GeometryUtil.n(a, (d + m) * 180 / Math.PI, b);
    ...
    PieChartBase.hp = /*@__PURE__*/ DependencyProperty.i("InnerExtent", Number_$type, PieChartBase.$, /*@__PURE__*/ new PropertyMetadata(2, 0, (a, b) => a.gu("InnerExtent", b.oldValue, b.newValue)));
    PieChartBase.h0 = /*@__PURE__*/ DependencyProperty.i("LabelTemplate", DataTemplate.$, PieChartBase.$, /*@__PURE__*/ new PropertyMetadata(2, null, (a, b) => a.gu("LabelTemplate", b.oldValue, b.newValue)));
    PieChartBase.io = /*@__PURE__*/ DependencyProperty.i("SelectedItem", Base.$, PieChartBase.$, /*@__PURE__*/ new PropertyMetadata(1, (a, b) => {
    ...
    PieChartBase.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, PieChartBase, 'gu', ['ActualBrushes:ak:hd', [BrushCollection.$, null], 'ActualItemsSource::he', [IEnumerable_$type, null], 'ActualLabelInnerColor:iy:hf', [Brush.$, null], 'ActualLabelOuterColor:iz:hg', [Brush.$, null], 'ActualOutlines:al:hh', [BrushCollection.$, null], 'AllowSliceExplosion:b8:hi', [0, true], 'AllowSliceSelection:b9:hj', [0, true], 'Brushes:am:hk', [BrushCollection.$, null], 'ExplodedRadius:c5:hl', [1, 0.2], 'FastItemsSource:bm:hm', [FastItemsSource.$], 'FormatLabel:a5:hn', [Delegate_$type], 'FormatLegendLabel:a6:ho', [Delegate_$type], 'IsDragInteractionEnabled:ce:hq', [0, false], 'IsSurfaceInteractionDisabled:cf:hr', [0, false], 'ItemsSource::hs', [IEnumerable_$type, null], 'LabelExtent:db:ht', [1, 10], 'LabelFormat:ef:hu', [2, null], 'LabelFormatSpecifiers:ag:hv', [Array_$type, null], 'LabelInnerColor:i0:hw', [Brush.$, null], 'LabelMemberPath:ej:hx', [2], 'LabelOuterColor:i1:hy', [Brush.$, null], 'LabelsPosition:az:hz', [LabelsPosition_$type, /*@__PURE__*/ enumGetBox(LabelsPosition_$type, 1)], 'LeaderLineMargin:dc:h1', [1, 6], 'LeaderLineStyle:ja:h2', [Style.$, null], 'LeaderLineType:a0:h3', [LeaderLineType_$type, /*@__PURE__*/ enumGetBox(LeaderLineType_$type, 0)], 'LeaderLineVisibility:je:h4', [Visibility_$type, /*@__PURE__*/ enumGetBox(Visibility_$type, 0)], 'LegendEmptyValuesMode:a1:h5', [LegendEmptyValuesMode_$type, /*@__PURE__*/ enumGetBox(LegendEmptyValuesMode_$type, 0)], 'LegendItemBadgeTemplate::h6', [DataTemplate.$, null], 'LegendItemTemplate::h7', [DataTemplate.$, null], 'LegendLabelFormat:ew:h8', [2, null], 'LegendLabelFormatSpecifiers:ah:h9', [Array_$type, null], 'LegendLabelMemberPath:ez:ia', [2], 'LegendOthersLabelFormat:e1:ib', [2, null], 'LegendOthersLabelFormatSpecifiers:ai:ic', [Array_$type, null], 'Legend::id', [IChartLegend_$type, null], 'OthersCategoryStyle:jb:ie', [Style.$, null], 'OthersCategoryText:e6:ig', [2, null], 'OthersCategoryThreshold:dd:ih', [1, 3], 'OthersCategoryType:a2:ii', [OthersCategoryType_$type, /*@__PURE__*/ enumGetBox(OthersCategoryType_$type, 1)], 'OthersLabelFormat:fa:ij', [2, null], 'OthersLabelFormatSpecifiers:aj:ik', [Array_$type, null], 'Outlines:an:il', [BrushCollection.$, null], 'RadiusFactor:dg:im', [1, 0.9], 'SelectedStyle:jc:ip', [Style.$, null], 'SelectionMode:bk:iq', [SliceSelectionMode_$type, /*@__PURE__*/ enumGetBox(SliceSelectionMode_$type, 1)], 'ShouldDisplayMockData:ch:ir', [0, false], 'ShouldUseSkeletonStyleForMockData:ci:is', [0, false], 'StartAngle:di:it', [1, 0], 'SweepDirection:i3:iu', [SweepDirection_$type, /*@__PURE__*/ enumGetBox(SweepDirection_$type, 1)], 'ToolTip:dr:iv', [4, null], 'ToolTipStyle:jd:iw', [Style.$, null], 'ValueMemberPath:fv:ix', [2, null]]);
    return PieChartBase;
})();
/**
 * @hidden
    ...
    class Slice extends ContentControl {
        ...
        bk() {
            ...
            if (ar && this.b8.height > 0 && this.b8.width > 0 && !b.containsRect(aq)) {
                ...
                at.intersect(as);
                let au = GeometryUtil.j((this.a3 + this.ax) / 2);
                ...
                let az = GeometryUtil.m(this.ai.i9.width, this.ai.i9.height, true, au, this.a2 * this.ai.c0 - ay);
        ...
        ca(a, b, c, d, e, f, g) {
            ...
            if ((0 > d && 0 < e) || (360 > d && 360 < e) || (e < d)) {
                h.add(GeometryUtil.n(f, 0, g));
            }
            if (90 > d && 90 < e) {
                h.add(GeometryUtil.n(f, 90, g));
            }
            if (180 > d && 180 < e) {
                h.add(GeometryUtil.n(f, 180, g));
            }
            if (270 > d && 270 < e) {
                h.add(GeometryUtil.n(f, 270, g));
            }
