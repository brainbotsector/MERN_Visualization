...
*/
    ...
    */
    ...
    getCategoryBoundingBox(point, useInterpolation, singularWidth) {
        let iv = this.i.me(toPoint(point), useInterpolation, singularWidth);
        return fromRect(iv);
    }
    getCategoryBoundingBoxHelper(point, useInterpolation, singularWidth, isVertical) {
        let iv = this.i.mf(toPoint(point), useInterpolation, singularWidth, isVertical);
        return fromRect(iv);
    }
    /**
    ...
    */
    unscaleValue(unscaledValue) {
        let iv = this.i.lc(unscaledValue);
        return (iv);
    }
