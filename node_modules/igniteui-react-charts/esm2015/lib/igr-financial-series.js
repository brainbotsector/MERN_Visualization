...
export class IgrFinancialSeries extends IgrSeries {
    ...
    */
    ...
    getSeriesCloseValue(world, useInterpolation, skipUnknowns) {
        let iv = this.i.xd(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    }
    getSeriesOpenValue(world, useInterpolation, skipUnknowns) {
        let iv = this.i.xe(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    }
    getSeriesVolumeValue(world, useInterpolation, skipUnknowns) {
        let iv = this.i.xf(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    }
    ...
    getSeriesOpenValuePosition(world, useInterpolation, skipUnknowns) {
        let iv = this.i.zd(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    }
    getSeriesCloseValuePosition(world, useInterpolation, skipUnknowns) {
        let iv = this.i.zc(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    }
    getSeriesVolumeValuePosition(world, useInterpolation, skipUnknowns) {
        let iv = this.i.ze(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    }
    /**
