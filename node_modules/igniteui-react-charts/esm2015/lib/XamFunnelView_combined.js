...
*/
import { Base, Point_$type, typeCast, runOn, delegateCombine, fromEnum, markType, EnumUtil, String_$type, delegateRemove, IEnumerable_$type, enumGetBox, markDep } from "igniteui-react-core";
    ...
    class XamFunnelView extends Base {
        ...
        a6(a) {
            ...
            if (b.i) {
                ...
                let k = this.ab();
                h.al = i;
                h.o = b.a4.y + b.a7.y - (k / 2);
                h.n = b.a4.x + this.u + b.a7.x - (j / 2);
                b.bg = new Rect(0, h.n, h.o, j, k);
                b.bn = h._visibility;
                c.x(h);
            }
            if (c.d && this.t != 1) {
...
export let XamFunnelChart = /*@__PURE__*/ (() => {
    ...
    XamFunnelChart.ex = /*@__PURE__*/ DependencyProperty.i("HighlightValueDisplayMode", HighlightedValueDisplayMode_$type, XamFunnelChart.$, /*@__PURE__*/ new PropertyMetadata(2, /*@__PURE__*/ enumGetBox(HighlightedValueDisplayMode_$type, 0), (a, b) => a.ed("HighlightValueDisplayMode", b.oldValue, b.newValue)));
    XamFunnelChart.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, XamFunnelChart, 'ed', ['AllowSliceSelection:be:ep', [0, false], 'BottomEdgeWidth:by:eq', [1, 0.35], 'Brushes:ah:er', [BrushCollection.$, null], 'FastItemsSource:az:es', [FastItemsSource.$], 'FunnelSliceDisplay:ak:et', [FunnelSliceDisplay_$type, /*@__PURE__*/ enumGetBox(FunnelSliceDisplay_$type, 0)], 'HighlightFastItemsSource:a0:ew', [FastItemsSource.$], 'HighlightValueOpacity:b0:ey', [1, 0.5], 'HighlightedItemsSource::eu', [IEnumerable_$type, null], 'HighlightedValueMemberPath:cr:ev', [2, null], 'InnerLabelMemberPath:cy:ez', [2, null], 'InnerLabelVisibility:ft:e0', [Visibility_$type, /*@__PURE__*/ enumGetBox(Visibility_$type, 0)], 'IsInverted:bk:e1', [0, false], 'ItemsSource::e2', [IEnumerable_$type, null], 'LegendItemBadgeTemplate::e3', [DataTemplate.$, null], 'LegendItemTemplate::e4', [DataTemplate.$, null], 'Legend::e5', [IChartLegend_$type, null], 'LowerBezierControlPoint:fp:e6', [Point_$type, { $type: Point_$type, x: 0.5, y: 1 }], 'OuterLabelAlignment:au:e7', [OuterLabelAlignment_$type, /*@__PURE__*/ enumGetBox(OuterLabelAlignment_$type, 0)], 'OuterLabelMemberPath:c9:e8', [2, null], 'OuterLabelVisibility:fu:e9', [Visibility_$type, /*@__PURE__*/ enumGetBox(Visibility_$type, 1)], 'OutlineThickness:b1:fb', [1, -1], 'Outlines:ai:fa', [BrushCollection.$, null], 'SelectedSliceStyle:fr:fc', [Style.$, null], 'ToolTip:cc:fd', [4, null], 'TransitionDuration:ca:fe', [1, 0], 'UnselectedSliceStyle:fs:ff', [Style.$, null], 'UpperBezierControlPoint:fq:fg', [Point_$type, { $type: Point_$type, x: 0.5, y: 0 }], 'UseBezierCurve:bl:fh', [0, false], 'UseOuterLabelsForLegend:bm:fi', [0, false], 'UseUnselectedStyle:bn:fj', [0, false], 'ValueMemberPath:dv:fk', [2, null]]);
